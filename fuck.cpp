...
int doit(const string& saida, const double tolerancia)
{
	...
	arquivoTempos.open("tempos.txt", ofstream::app);
	...
	arquivoTempos << "Para uma tolerancia = " << tolerancia << " fiz um total de " << totalDeChamadas << " chamadas e o tempo total foi de " << (double)(fim-inicio)/CLOCKS_PER_SEC << "s" << endl;
